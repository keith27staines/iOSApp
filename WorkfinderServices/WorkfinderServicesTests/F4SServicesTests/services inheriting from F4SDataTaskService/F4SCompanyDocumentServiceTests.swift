...
class F4SCompanyDocumentServiceTests: XCTestCase {
    ...
    func test_initialise() {
        let sut = F4SCompanyDocumentService(configuration: makeTestConfiguration())
    ...
    func test_getDocuments() {
        ...
        XCTAssertEqual(sut.url.absoluteString, "apiBaseUrl/v2/company/companyUuid/documents")
