...
class KeyActivityCell: SimpleTextCell {
    ...
    override func configureViews() {
        ...
        bulletPointStack.anchor(top: contentView.topAnchor, leading: contentView.leadingAnchor, bottom: contentView.bottomAnchor, trailing: contentView.trailingAnchor, padding: UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 0))
    }
}
