...
class TabBarCoordinator : CoreInjectionNavigationCoordinatorProtocol, TabBarCoordinatorProtocol {
    ...
    func presentCompanyDetailsPopover2(parentCtrl: UIViewController, company: Company) {
        ...
        let companyCoordinator = factory.makeCompanyCoordinator(parent: self, navigationRouter: navigationRouter, company: company)
