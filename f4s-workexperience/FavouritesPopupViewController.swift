...
extension FavouritesPopupViewController {
    ...
    func setupButtons() {
        ...
        okButton.setAttributedTitle(NSAttributedString(string: NSLocalizedString("Ok", comment: ""), attributes: [NSFontAttributeName: UIFont.f4sSystemFont(size: Style.biggerMediumTextSize, weight: UIFontWeightRegular), NSForegroundColorAttributeName: UIColor(netHex: Colors.white)]), for: .normal)
        ...
        cancelButton.setAttributedTitle(NSAttributedString(string: NSLocalizedString("Cancel", comment: ""), attributes: [NSFontAttributeName: UIFont.f4sSystemFont(size: Style.biggerMediumTextSize, weight: UIFontWeightRegular), NSForegroundColorAttributeName: UIColor(netHex: Colors.black)]), for: .normal)
    }
    ...
    func setupLabels() {
        ...
        contentLabel.attributedText = NSAttributedString(string: contentText, attributes: [NSFontAttributeName: UIFont.f4sSystemFont(size: Style.smallerMediumTextSize, weight: UIFontWeightRegular), NSForegroundColorAttributeName: UIColor(netHex: Colors.black)])
