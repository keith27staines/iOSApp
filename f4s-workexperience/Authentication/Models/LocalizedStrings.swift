...
public struct LocalizedStrings {
    ...
    public struct ErrorCorrectiveActions {
        static let networkErrorSubmittingEmail = NSLocalizedString(
        "We were unable to submit your email for verification due to a network error. Please make sure you have a good internet connection and try again",
        ...
        static let emailFormatError = NSLocalizedString(
            "Your email address seems to be incorrectly formatted. Please try again",
            comment: "Ask the user to correct their email address")
        
        static let networkErrorProcessingLink = NSLocalizedString(
            "We were unable to process the link do to a network error. Please make sure you have a good internet connection and try again",
        ...
        static let codeEmailCombinationInvalid = NSLocalizedString(
            "We were unable to verify your email. This might be because there is an error in your email address or the link might have expired. Please ensure your email address is correct and try again",
    ...
    public struct IntroductionStrings {
        ...
        static let emailSent = NSLocalizedString("We have sent you a link", comment: "Advise the user that we have sent them a link")
        ...
        static let  previouslyVerified = NSLocalizedString("Use this email address?", comment: "Ask the user if they want to continue with their verified email address")
    }
    ...
    public struct FeedbackStrings {
        ...
        static let emailSent = NSLocalizedString(
            "We have sent a link to your email address but it might take a few minutes to arrive. When it does, please open it on this device",
        ...
        static let  previouslyVerified = NSLocalizedString(
            "This is the verified email address we currently hold for you, but you can update it now if you need to",
    ...
    public struct ButtonTitles {
        ...
        static let requestVerificationLink = NSLocalizedString("Request verification link", comment: "Instruct Workfinder to send a verification link")
        
        static let processLink = NSLocalizedString("Process link", comment: "Request Workfinder to process the link it has received")
        
        static let next = NSLocalizedString("Next", comment: "Tell Workfinder to continue with whatever workflow comes after email verification")
