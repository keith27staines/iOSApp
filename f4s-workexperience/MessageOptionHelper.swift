...
class MessageOptionHelper {
    ...
    func getCellSize(options: [F4SCannedResponse], index: Int, font: UIFont = UIFont.f4sSystemFont(size: Style.smallerMediumTextSize, weight: UIFont.Weight.regular)) -> CGSize {
    ...
    func getFooterSize(options: [F4SCannedResponse], font _: UIFont = UIFont.f4sSystemFont(size: Style.smallerMediumTextSize, weight: UIFont.Weight.regular)) -> CGSize {
