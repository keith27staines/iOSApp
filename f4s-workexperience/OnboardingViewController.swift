...
extension OnboardingViewController {
    ...
    func setUpButtons() {
        ...
        enableLocationButton.setAttributedTitle(NSAttributedString(string: enableLocationText, attributes: [NSFontAttributeName: UIFont.f4sSystemFont(size: Style.mediumTextSize, weight: UIFontWeightRegular), NSForegroundColorAttributeName: UIColor.black]), for: .normal)
        enterLocationButton.setAttributedTitle(NSAttributedString(string: enterLocationText, attributes: [NSFontAttributeName: UIFont.f4sSystemFont(size: Style.mediumTextSize, weight: UIFontWeightRegular), NSForegroundColorAttributeName: UIColor.white]), for: .normal)
    ...
    func setupLabels() {
        ...
        descriptionLabel.attributedText = NSAttributedString(string: descriptionText, attributes: [NSFontAttributeName: UIFont.f4sSystemFont(size: Style.hugeTextSize, weight: UIFontWeightThin), NSForegroundColorAttributeName: UIColor.white])
    }
