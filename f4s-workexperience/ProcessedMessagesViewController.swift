...
extension ProcessedMessagesViewController {
    ...
    func setupAddInfoButton() {
        ...
        addInfoButton.setAttributedTitle(NSAttributedString(string: addInfoText, attributes: [NSFontAttributeName: UIFont.f4sSystemFont(size: Style.biggerMediumTextSize, weight: UIFontWeightRegular), NSForegroundColorAttributeName: UIColor.white]), for: .normal)
    }
    ...
    func setupLabels() {
        ...
        formattedString.append(NSAttributedString(string: receivedLabelText, attributes: [NSFontAttributeName: UIFont.f4sSystemFont(size: Style.largeTextSize, weight: UIFontWeightRegular), NSForegroundColorAttributeName: UIColor(netHex: Colors.black)]))
        if let currentCompanyName = currentCompany?.name {
            formattedString.append(NSAttributedString(string: currentCompanyName, attributes: [NSFontAttributeName: UIFont.f4sSystemFont(size: Style.largeTextSize, weight: UIFontWeightSemibold), NSForegroundColorAttributeName: UIColor(netHex: Colors.black)]))
        }
        ...
        self.extraInformationLabel.attributedText = NSAttributedString(string: extraInformationText, attributes: [NSFontAttributeName: UIFont.f4sSystemFont(size: Style.largeTextSize, weight: UIFontWeightRegular), NSForegroundColorAttributeName: UIColor(netHex: Colors.black)])
