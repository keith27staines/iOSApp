...
extension EditCoverLetterViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch editableSection {
        case .personalAttributes:
            TabBarCoordinator.sharedInstance.pushChooseAttributes(navCtrl, currentTemplate: template, attribute: .PersonalAttributes)
        case .jobRole:
            TabBarCoordinator.sharedInstance.pushChooseAttributes(navCtrl, currentTemplate: template, attribute: .JobRole)
        ...
        case .skills:
            TabBarCoordinator.sharedInstance.pushChooseAttributes(navCtrl, currentTemplate: template, attribute: .EmploymentSkills)
        }
        coverLetterTableView.reloadData()
    }
